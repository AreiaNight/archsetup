# Generated by Powerlevel10k configuration wizard on 2024-08-15 at 12:35 CST.
...
# slanted separators, round heads, round tails, 1 line, compact, many icons, fluent,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=023
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=004
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=010
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=010
